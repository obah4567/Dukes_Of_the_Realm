 ...
 * This describes the Castle and every operations connected to it
 */
import java.io.Serializable;
import javafx.scene.image.Image;
import javafx.scene.layout.Pane;
import java.util.*;
public class Castle extends Sprites implements Serializable{
	 ...
	 */
	private transient ArrayList<Troops> def = new ArrayList<Troops>();
	...
	{
		return super.toString() + duc + "|" + treasure + "|" + level + "|" + troops[0] + "|" + troops[1] + "|" + troops[2] + 
